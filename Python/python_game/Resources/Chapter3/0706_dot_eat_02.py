...
red_d = 0           # 레드의 방향 변수
red_a = 0           # 레드의 이미지 번호
red_sx = 0          # 레드의 초기 위치 x 좌표
red_sy = 0          # 레드의 초기 위치 x 좌표
...
def draw_screen():              # 게임 화면 미로 그리기 함수
    ...
    draw_txt('STAGE' + str(stage), 520, 30, 30, 'lime')         # 스테이지 표시 함수 호출
...
def main():                 # 메인 루프
    global  key, koff, tmr, idx, score, stage       # 전역변수 참조
    tmr += 1
    draw_screen()           # 화면 그리기
