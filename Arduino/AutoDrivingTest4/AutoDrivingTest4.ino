...
#define RED_1 16 // (A0) RGB LED 1번의 RED
#define RED_2 15 // (A1) RGB LED 2번의 RED
#define RED_3 14 // (A2) RGB LED 3번의 RED
#define ULTRA_1T 8 // 1번 초음파 센서 Trigger
#define ULTRA_1E 9 // 1번 초음파 센서 Echo
#define ULTRA_2T 6 // 2번 초음파 센서 Trigger
#define ULTRA_2E 7 // 2번 초음파 센서 Echo
#define ULTRA_3T 4 // 3번 초음파 센서 Trigger
#define ULTRA_3E 5 // 3번 초음파 센서 Echo
